...
function Homepage(){
    return <>
        <div className="site-container">
            <h1 className="text-normal-blue text-3xl text-center font-semibold md:mt-20 mt-8 mb-10">Kiralık Vinç, Kiralık Forklift, Sepetli Platform ve Makaslı Platform</h1>
            <Carousel  className="mx-5 md:brightness-50 md:hover:brightness-110 md:transition md:delay-100 md:ease-in-out" autoFocus={true}  showArrows={true} infiniteLoop={true} autoPlay={true} interval={6000} showStatus={false} showThumbs={true} >
                <div className="px-8">
            ...
            <div className="md:flex md:space-x-6 md:mx-28 space-y-3 md:space-y-0 ml-10 mb-10 ">
                <div className="text-normal-blue hover:text-dark-blue transition">
